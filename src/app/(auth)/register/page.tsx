...
import { Mail, Lock, ArrowRight, UserPlus, Sparkles } from "lucide-react";
    ...
    <div className="min-h-screen bg-background text-foreground flex items-center justify-center px-4 overflow-hidden relative transition-colors duration-300">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-black tracking-tight mb-2">Join Studio</h1>
          <p className="text-muted-foreground font-medium">Start your journey today</p>
        </div>
        ...
        <div className="bg-card/50 backdrop-blur-xl rounded-[32px] p-10 border border-border shadow-2xl">
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-muted-foreground font-medium">
              ...
              <Link href="/login" className="text-foreground font-bold hover:underline decoration-accent underline-offset-4">Sign in</Link>
            </p>
          </div>
        </div>
      </motion.div>
